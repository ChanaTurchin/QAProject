...
import { QuestionAnswerItemModel } from '../../shared/models/question-answer-item.model';
...
export class AddQuestionComponent implements OnInit {
  ...
  public question: QuestionModel = new QuestionModel(0, "", [new QuestionAnswerItemModel(QuestionItemTypeEnum.Text, "")], 7, null, null, null, null, 0, new Date());
  ...
  addText() {
    this.question.items.push(new QuestionAnswerItemModel(QuestionItemTypeEnum.Text, ""));
  }

  attachFile() {
    this.question.items.push(new QuestionAnswerItemModel(QuestionItemTypeEnum.Image, null));
  }
